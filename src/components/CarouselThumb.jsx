...
const CarouselThumb = ({
  ...
  return (
    <div className="relative">
      ...
      >
        <Header />
        <div className="container pb-20 md:mx-auto md:px-5 relative flex justify-center lg:justify-between items-center">
          ...
          <div className="px-4 pt-24 lg:mt-0 mb-10 lg:basis-3/5">
